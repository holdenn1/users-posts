...
var ageInput = document.querySelector('.filter__age-input');
...
function _searchUsers() {
  _searchUsers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data, inputValue, findUsers;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          data = _context.sent;
          inputValue = +ageInput.value;
          findUsers = data.filter(function (data) {
            return data.age == inputValue;
          });
          if (findUsers.length == 0) {
            error();
          }
          findUsers.forEach(function (element) {
            var id = element.id,
              name = element.name,
              age = element.age,
              photo = element.photo,
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/filter.js"], null)
